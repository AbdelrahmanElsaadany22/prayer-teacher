...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    'pattern.ornament': 'Ornament',
    'pattern.stonework': 'Stonework',
    'pattern.lineWeight': 'Line weight',
    'pattern.opacity': 'Opacity',
    'pattern.border': 'Border',
    'pattern.seed': 'Seed',
    'pattern.shuffle': 'Randomize seed',
    'pattern.seedHint': 'Every design is fully reproducible from its seed.',
    'pattern.construct': 'Construct',
    'pattern.constructed': 'Applied ✓',
  ...
  ar: {
    ...
    'pattern.material.limestone': 'الحجر الجيري',
    'pattern.material.gypsum': 'نقش الجص',
    'pattern.material.bronze': 'تطعيم برونزي',
    'pattern.material.pearl': 'جص لؤلؤي',
    'pattern.material.nightShadow': 'ظل الليل',
    'pattern.geometry': 'الهندسة',
    'pattern.complexity': 'التعقيد',
    'pattern.density': 'الكثافة',
    'pattern.spacing': 'التباعد',
    'pattern.ornament': 'الزخرفة',
    ...
    'pattern.construct': 'إنشاء',
    'pattern.constructed': 'تم التطبيق ✓',
